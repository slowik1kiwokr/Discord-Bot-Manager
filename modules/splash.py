...
class SplashScreen(ctk.CTk):
    ...
    def safe_destroy(self):
        """Biztonságos megsemmisítés — az összes függő callback-et törli."""
        self._closing = True

        # 1) Saját animációs after-ek
        ...
        # 2) Az ÖSSZES függő after callback törlése (CTk belső is)
        try:
        ...
        # 3) Rövid várakozás, hogy a Tk feldolgozza a törléseket
        try:
            self.update_idletasks()
        except Exception:
            pass
